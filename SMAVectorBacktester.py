...
class SMAVectorBacktester(object):
    ...
    def __init__(self, symbol, SMA1, SMA2, start, end, data):
        self.symbol = symbol
        self.SMA1 = SMA1
        self.SMA2 = SMA2
        self.start = start
    ...
    def plot_results(self):
        ...
        title = '%s | SMA_1=%d, SMA_2=%d' % (self.symbol,
                                               self.SMA1, self.SMA2)
...
if __name__ == '__main__':
    smabt = SMAVectorBacktester('EUR=', 30, 150,
                                '2020-1-1', '2024-1-1')
    print(smabt.run_strategy())
    smabt.set_parameters(SMA1=30, SMA2=150)
    print(smabt.run_strategy())
    print(smabt.optimize_parameters((20, 50, 3), (150, 300, 6)))